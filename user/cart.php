                                    ...
                                    <tr class="table-body-row animate__animated animate__fadeIn">
                                        ...
                                        <td class="product-image">
                                            <?php if (file_exists($imagePath)): ?>
                                                <img src="<?= htmlspecialchars($imagePath) ?>" alt="Product Image" class="cart-img animate__animated animate__zoomIn">
                                            <?php else: ?>
                                                <img src="../assets/images/placeholder.png" alt="No Image" class="cart-img animate__animated animate__zoomIn">
                                            <?php endif; ?>
                                        </td>
