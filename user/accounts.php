                    ...
                    <div class="card-body">
                        <form id="userInfoForm">
                            <div class="input-group mb-3">
                                ...
                                <input type="number" class="form-control" required id="stud_id"
                            ...
                            <div class="input-group mb-3 d-grid">
                                <button class="btn btn-primary" type="button" id="addUserBtn" onclick="addUser()">Add
                                    User</button>
                                <button class="btn btn-primary mt-2" type="button" id="updateUserBtn"
                                    onclick="updateUser()" style="display: none;">Update User</button>
                            </div>
                        </form>
                    </div>
                </div>
